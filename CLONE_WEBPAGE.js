//I disabled the button system (when you click them, it updates the page and does not reload) because it opens like a billion tabs. im trying to fix it though.
